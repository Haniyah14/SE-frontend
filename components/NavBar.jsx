    ...
    return (
        <div className='w-full'>
            ...
            <div className='flex items-center justify-between py-5 px-4 sm:px-[5vw]'>
                <Link to='/'>
                    <img src={assets.logo} className='w-36' alt="Aura" />
                </Link>
            ...
            <div className='bg-black py-2 relative hidden md:block'>
                <ul className='flex justify-center gap-6 text-sm text-white'>
                    ...
                    >
                        ...
                        {showMegaMenu && (
                            <div className='absolute left-0 top-full bg-white shadow-lg p-4 flex flex-col gap-2 text-black w-32'>
                                <NavLink to='/collection/ForHim' className='hover:text-gray-700'>
                                    For Him
                                </NavLink>
                                <NavLink to='/collection/ForHer' className='hover:text-gray-700'>
                                    For Her
                                </NavLink>
                                <NavLink to='/collection/Unisex' className='hover:text-gray-700'>
                                    Unisex
                                </NavLink>
                            </div>
                        )}
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={() => setVisible(false)} className='py-2 pl-6 border' to='/collection/ForHim'>For Him</NavLink>
                    <NavLink onClick={() => setVisible(false)} className='py-2 pl-6 border' to='/collection/ForHer'>For Her</NavLink>
                    <NavLink onClick={() => setVisible(false)} className='py-2 pl-6 border' to='/collection/Unisex'>Unisex</NavLink>
